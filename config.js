module.exports = {
	...
	adminId: "725379419350237254", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "", //- Bot's Token
	clientId: process.env.clientId || "1056515585703428117", //- ID of the bot
	clientSecret: process.env.clientSecret || "DQTyEkuLGwMQlyqTfqd46jEjbN5iwAb-", //- Client Secret of the bot
	port: 4200, //- Port of the API and Dashboard
	scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
	inviteScopes: ["bot", "applications.commands"], // Invite link scopes
	serverDeafen: true, //- If you want bot to stay deafened
	defaultVolume: 100, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
	supportServer: "https://discord.gg/5C3PwPN4tV", //- Support Server Link
	Issues: "https://discord.gg/5C3PwPN4tV", //- Bug Report Link
	...
	nodes: [
		{
			identifier: "AjieDev", //- Used for indentifier in stats commands.
	...
	embedColor: "#1f0054", //- Color of the embeds, hex supported
	presence: {
